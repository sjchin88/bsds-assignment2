...
public class HttpClient implements Runnable{
  ...
  protected static final int SWIPER_UPPER = 5001;
  ...
  public String buildJson(){
    ...
    sb.append(", \"comment\":\"");
    sb.append(this.getRandomComment());
    sb.append("\"}");
    return sb.toString();
  }
  ...
  /**
   * Get a random comment from given comments pool
  ...
  public void run() {
    ...
    counter.addCount(this.countSuccess, this.countFailure);
